        ...
        {messages.length === 0 && !isLoading && (
          <div className="text-center text-gray-400 py-6 sm:py-8">
            ...
            <p className="text-xs sm:text-sm max-w-3/4 mx-auto">
              You can ask questions about the database, ask to generate SQL queries and run them. You can configure the
              mode of the generation to be one shot or conversational.
            </p>
            <p className="text-xs mt-3 text-gray-500">
              Try: &quot;Show me all users&quot; or &quot;Find customers who made purchases over $1000&quot;
            </p>
          </div>
        )}
